...
| Lane file (`examples/graphics_specs/`) | The look | Density |
|---|---|---|
...
Switching lanes is one flag: `--graphics examples/graphics_specs/<lane>.json`.
...
1. **Generate** the exemplar through every backend you hold credentials
   ...
   uv run python examples/run_platformer_slice.py \
     ...
     --graphics examples/graphics_specs/hand_drawn_16bit.json \
