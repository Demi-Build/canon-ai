...
class MazeworldManifestPhase(_BaseManifestPhase):
    ...
    - ``manifest.json.pack_type``: the P.4.1 mirror falls back to THIS
      writer's registry id when the context carries none (legacy callers);
      the core base phase carries no pack id.
    """

    pack_type: str | None = "dungeon"
