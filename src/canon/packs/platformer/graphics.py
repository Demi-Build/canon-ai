...
- **Values are template data.** They load from a per-game JSON file
  ...
  swap: ``src/canon/packs/platformer/graphics_specs/{snes_pixel,rendered_hd}.json``.
...
class GraphicsSpec(BaseModel):
    ...
    #: templates in src/canon/packs/platformer/graphics_specs/ are the editable style
