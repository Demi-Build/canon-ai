...
collision the two play surfaces run — play.py and its
...
from canon.packs.platformer.combat import (
    DEFAULT_COMBAT,
    CombatSpec,
    effective_size,
    occupancy,
...
# (play.py's update loop and godot_template/godot/main.gd's
...
def swimmer_spot_exists(
    ...
    from canon.packs.platformer.combat import occupancy
...
def snap_checkpoints(
    ...
    from canon.packs.platformer.dsl import DslError, parse_dsl, stamp
